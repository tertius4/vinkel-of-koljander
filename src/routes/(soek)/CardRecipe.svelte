...
>
  <div class="h-56 relative overflow-hidden bg-surface-container-low flex items-center justify-center">
    {#if data.cover_image}
      <img
    ...
    <button
      ...
      class="absolute top-4 right-4 bg-neutral-800/90 p-2 rounded-xl text-white hover:text-primary-500 transition-colors shadow-sm"
      onclick={async (e) => {
        e.preventDefault();
